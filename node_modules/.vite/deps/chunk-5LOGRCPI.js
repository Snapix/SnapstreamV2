...
var AudioProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-CnCZVzrO-KVA7CET4.js")).AudioProvider(this.target, ctx);
  }
};
...
var _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import("./vidstack-3ZPG_odG-24ZF6RJ2.js")).HLSProvider(this.target, context);
  }
};
...
var VimeoProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-Bt-dOpts-LK55XR2Z.js")).VimeoProvider(this.target, ctx);
  }
...
var YouTubeProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-CoE5RD0i-4INN5AZH.js")).YouTubeProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
    const { findYouTubePoster, resolveYouTubeVideoId } = await import("./vidstack-Dm1xEU9Q-I4ROP32Y.js");
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!__privateGet(this, _googleCastLoader)) {
        const $module = await import("./vidstack-BM-FgV9W-BI2FEPFA.js").then(function(n) {
          return n.loader;
        });
...
//# sourceMappingURL=chunk-5LOGRCPI.js.map
